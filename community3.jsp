    ...
    <div class="comm_main">
        <div class="btns_container">
            <div class="btns">
                ...
                <button class=" btn" onclick="location.href='community3.jsp'"
                    style="background-color: white; color:#FFB02E;">방명록</button>
            </div>
        </div>
        <div class="guests_container">
            <div class="guests">
                <form class="js-postForm">
                    <input type="text" placeholder="😍 내용을 작성한 뒤 엔터(Enter)를 눌러주세요 😍">
                </form>
                <ul class="js-postList">
                </ul>
            </div>
        </div>
    </div>
