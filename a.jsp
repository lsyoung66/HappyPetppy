   ...
   <%
    ...
    <div class="comm_main">
       ...
       <div class="write_container">
            ...
            <thead>
               ...
               <tr style="">
                ...
                <img class="profile" src="img/profile.png" style="padding: 5px 8px;"><%= bbs.getUserID() %></th> <!-- 작성자 -->
                  <th style="text-align: left; padding: 5px 12px; font-size: 12px; width:130px; border-left:1px solid #ddd;  border-bottom: 2px solid #ddd;"><%= bbs.getBbsDate().substring(0, 11) + bbs.getBbsDate().substring(11, 13) 
                        + ":" + bbs.getBbsDate().substring(14, 16) %></th> <!-- 작성일 -->
         ...
         <div style="display: flex; justify-content: space-around; margin-top: 30px;" class="writeBox_btns">
         <a href="community.jsp"  class="list">목록</a>
         <%
            if (userID != null && userID.equals(bbs.getUserID())) {
         %>
               <a href="update.jsp?bbsID=<%= bbsID %>" class="edit">수정</a>&nbsp;&nbsp;
               
               <a onclick="return confirm('정말 삭제하시겠습니까?')" 
                 href="deleteAction.jsp?bbsID=<%= bbsID %>" class="delete">삭제</a>
         <%   
            }
         %></div>
      </div>
